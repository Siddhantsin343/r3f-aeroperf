...
Drop a single component inside your canvas `<AeroPerf>` and get a modern style overlay showing FPS, GPU/CPU frame timing, draw calls, triangle counts, VRAM usage, and more — updated live, every frame.
...
For a compact readout with no dial or graph:
